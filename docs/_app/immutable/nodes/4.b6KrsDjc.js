import{s as _,n as M}from"../chunks/scheduler.GyfY70HZ.js";import{S as A,i as O,e as p,s as w,c as u,k as f,f as g,l as v,g as s,d as a}from"../chunks/index.qNTfrIfu.js";import{b as m}from"../chunks/paths.RGQ3Jhc3.js";function K(W){let o,q=`<div class="wrapper svelte-94ljf6" style="padding: 3rem 1rem 0rem 1rem;"><img class="nav-img svelte-94ljf6" src="${m}/assets/kroger-footer-logo.png" alt=""/> <div class="list-itmes svelte-94ljf6"><h3>Roles</h3> <ul class="list-outside inline-block"><li>UX Researcher</li> <li>Product Designer</li></ul></div> <i class="disclaimer svelte-94ljf6">*Not all solutions can be shown due to intellectual property of client*</i></div> <div class="wrapper svelte-94ljf6"><section class="section-title svelte-94ljf6"><h3 class="svelte-94ljf6">Fresh For Everyone</h3> <div class="section-text col-cnt-2 svelte-94ljf6"><p class="svelte-94ljf6"><strong>&quot;Fresh for Everyone&quot;</strong> is more than just a slogan; it&#39;s
        ...
        was limited by safety regulations.</p> <p class="svelte-94ljf6">Such was the state of the product I enherited when joining Kroger in
        ...
        key leadership positions leading to a slow progress due to lack of direction.</p></div></section> <div class="article-text svelte-94ljf6"><div class="paragraph"><p class="svelte-94ljf6">I set about getting familiar with the current state of the app and how
        ...
        ceertain flows of the app and get feedback.</p> <p class="svelte-94ljf6">Talking to users is one of the best parts about being a Product
        ...
        bakery associates worked and what they had to do on a daily basis.</p> <p class="svelte-94ljf6">For the two stores I was able to go in to, the Cincinnati store did not
        ...
        in place. The problems came from accuracy of numbers and user adoption.</p> <p class="svelte-94ljf6">I ran a few workshops within the team to brainstorm solutions for the
        ...
        validations of the designs.</p> <p class="svelte-94ljf6">Testing proved to be a little tricky to work through. Often times they
        ...
        I wasn’t trying to test.</p></div></div> <div class="article-text svelte-94ljf6"><div class="paragraph col-cnt-2 svelte-94ljf6"><p class="svelte-94ljf6">For the new counting feature, I tested in a few stores that weren’t
        ...
        the trust in the app.</p> <p class="svelte-94ljf6">Once we were satisfied with the feedback, we worked on developing this
        ...
        was positve on both sides.</p> <p class="svelte-94ljf6">So we launched the app enterprise wide. We created training documents in
        ...
        our data.</p></div></div> <div class="article-text svelte-94ljf6"><div class="paragraph"><p class="svelte-94ljf6">I won&#39;t say we satisfied every associate but the feedback we were
